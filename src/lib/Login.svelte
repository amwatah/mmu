...
<div class="">
	<input bind:value={ userName} type="text" class="input input-primary mt-1 " placeholder="Username" />
	<br />
	<input bind:value={ password } type="text" class="input input-primary mt-1 " placeholder="Password" />
